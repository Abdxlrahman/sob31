...
def check_winner(game):
    ...
    return 0 # AR fixed 'return winner' to 'return 0'
...
def add_piece(game, player, row, column):
    ...
    """
    game[row][column] = player # AR fixed index error - 'column=1' to 'column'
    return game
...
if __name__ == '__main__':
    ...
    while winner == 0 and moves_exist(game):
        ...
        available = False
        while not available:  # AR fixed missing colon(:)
